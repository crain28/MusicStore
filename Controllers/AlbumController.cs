    ...
    public class AlbumController : Controller
    {
        ...
        public IActionResult Index(int ArtistSort=0, int GenreSort=0)
        {
            if (ArtistSort == 1 && GenreSort == 0)
                return View(_context.Albums.Include(a => a.Artist.Name).OrderBy(a => a.Artist.Name).Include(a => a.Genre).ToList());
                ...
                return View(_context.Albums.Include(a => a.Artist.Name).OrderByDescending(a => a.Artist.Name).Include(a => a.Genre).ToList());
